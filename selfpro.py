...
#cl = LineClient()
cl = LineClient(authToken='EHku6NIowwPXt3H01It7.hz46BYRkxwOdFEYFX+V5jW.Xykrhmuaf/Zp0Bn4RSDgZ4h8oE1FliYkwjXt2nv3hrI=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='EHnZ63L42bC2uXUuUElb.MpHQLhQod4AT+45V/FNTkW.4H5vAs90DVQJRShHrOOzQtnG5oXEancncDZG32izLOI=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='EHooWftFbA1nBfrFrLo8.NpxGl5SRCWwcglMrJdVysa.EIIYeiIVM9UN+GL1KEmFmUAWdQXDW/OF1Fx4nfcWrso=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='EHwAA0o8hUNS1zTm8PN9.mElAK9oVMqZtLttM+uZtQq.W5NkFu+haRqu0K9p2pjptrSEpIr+fPtK8r4rlBGipuU=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='EHwpfIJv76d7NynHfcjd.UI0Ougl8QhtHKAdLyq6JBq.1HaSk+EvLjOygZVJJ1bSb3YweJ8yrxCnFAWUdFtAujI=')
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"Shiro.bot Creator") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage1(msg)
                               cl.sendMessage(msg.to,"「 SQUAD Shiro.bot」")
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, "「 SQUAD Shiro.bot 」Grup Info\n\nNama Group : {}".format(G.name)+ "\n❧ID Group : {}".format(G.id)+ "\n❧Pembuat : {}".format(G.creator.displayName)+ "\n❧Waktu Dibuat : {}".format(str(timeCreated))+ "\n❧Jumlah Member : {}".format(str(len(G.members)))+ "\n❧Jumlah Pending : {}".format(gPending)+ "\n❧Group Qr : {}".format(gQr)+ "\n❧Group Ticket : {}".format(gTicket))
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated = []
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += "●➢「 SQUAD Shiro.bot」 Grup Info\n"
                                ret_ += "\n●➢Nama Group : {}".format(G.name)
                                ret_ += "\n●➢ID Group : {}".format(G.id)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"●➢「User bot 」\n\nOwner:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」「SQUAD Shiro.bot 」 " %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                G.preventedJoinByTicket = True
                                kc.updateGroup(G)
                                ki.sendMessage(msg.to,"「 Shiro.bot 1 DONE」")
                                kk.sendMessage(msg.to,"「Shiro.bot 2 DONE」")
                                kc.sendMessage(msg.to," 「 Shiro.bot 3 DONE」")
                                sw.sendMessage(msg.to,"「 Shiro.bot COMPLETE ...」")

                        elif cmd == "out":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                ki.sendText(msg.to, "「SQUAD Shiro.bot  PAMIT DULU .. MAU CARI MAKAN!! BYE 」 "+str(G.name))
...
#===========COMMAND SET============#
                        ...
                        elif cmd == "bacol team" or msg.text.lower == "bacol team":
                            if msg._from in admin:
                               cl.sendMessage(to," 「ADMIN Shiro.bot HADIR」")
                               ki.sendMessage(to," 「Shiro.bot 1」")
                               kk.sendMessage(to," 「Shiro.bot 2」")
                               kc.sendMessage(to,"「 Shiro.bot 3 」")
